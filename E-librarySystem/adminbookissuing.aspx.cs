    ...
    public partial class adminbookissuing : System.Web.UI.Page
    {
            ...
            bool checkIfMemberExist()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select first_name from member_master_tbl WHERE member_id='" + TextBox2.Text.Trim() + "'", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
        ...
        void getNames()
        {
            try
            {
                ...
                cmd = new SqlCommand("select first_name from member_master_tbl WHERE member_id='" + TextBox2.Text.Trim() + "'", con);
