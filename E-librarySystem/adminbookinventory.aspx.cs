     ...
     void deleteBookByID()
        ...
        void updateBookByID()
        {
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("UPDATE book_master_tbl set book_name=@book_name, genre=@genre, author_name=@author_name, publisher_name=@publisher_name, publish_date=@publish_date, language=@language, actual_stock=@actual_stock, current_stock=@current_stock, edition=@edition, no_of_pages=@no_of_pages, book_description=@book_description, book_img_link=@book_img_link where book_id='" + TextBox1.Text.Trim() + "'", con);
        ...
        void addNewBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_master_tbl(book_id,book_name,genre,author_name,publisher_name,publish_date,language,actual_stock,current_stock,edition,no_of_pages,book_description,book_img_link) " +
                    "values(@book_id,@book_name,@genre,@author_name,@publisher_name,@publish_date,@language,@actual_stock,@current_stock,@edition,@no_of_pages,@book_description,@book_img_link)", con);
