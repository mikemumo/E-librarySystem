<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" Inherits="E_librarySystem.adminbookinventory" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img id="imgview" height="100px" width="150px" src="book_inventory/books.jpg" />                            
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label>Book Description</label>
                                 <div class="form-group">
                                     <asp:TextBox class="form-control" ID="TextBox9" runat="server" placeholder="Book Description" ></asp:TextBox>
                                 </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <asp:Button class="btn btn-warning btn-lg btn-block" ID="Button4" runat="server" Text="Update" OnClick="Button4_Click"/>
                            </div>
                            <div class="col-4">
